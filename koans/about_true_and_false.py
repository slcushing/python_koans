...
class AboutTrueAndFalse(Koan):
    ...
    def test_empty_collections_are_treated_as_false(self):
        self.assertEqual('false stuff', self.truth_value([])) #empty lists are considered False in Python https://flexiple.com/check-if-list-is-empty-python/
        self.assertEqual('false stuff', self.truth_value(())) #empty tuple always evaluates to False
