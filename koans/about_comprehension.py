...
class AboutComprehension(Koan):
    ...
    def test_creating_lists_with_list_comprehensions(self):
        ...
        self.assertEqual("Lambs", comprehension[0])  #capitalizing the first letter of index 0 in feast
        self.assertEqual("Orangutans", comprehension[2]) #capitalizing the first letter of index 2 in feast
    ...
    def test_filtering_lists_with_list_comprehensions(self):
        ...
        self.assertEqual(5, len(feast)) #length of the items in list 'feast'
        self.assertEqual(3, len(comprehension)) #length of items in list 'feast' that are more than 6 letters in length
    ...
    def test_creating_a_dictionary_with_dictionary_comprehension(self):
        ...
        self.assertEqual(False, 'first' in dict_comprehension)  #doesn't do the upper()
