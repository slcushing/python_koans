...
class AboutStringManipulation(Koan):
    ...
    def test_any_python_expression_may_be_interpolated(self):
        ...
        decimal_places = 4
        string = "The square root of 5 is {0:.{1}f}".format(math.sqrt(5), #f-string - can you put it after?
            decimal_places)
        self.assertEqual("The square root of 5 is 2.2361", string)

    def test_you_can_get_a_substring_from_a_string(self):
        string = "Bacon, lettuce and tomato"
        self.assertEqual("let", string[7:10]) #string index starting at zero, pulling from index position 7 up to BUT NOT INCLUDING index 10 https://www.pythoncentral.io/cutting-and-slicing-strings-in-python/
    ...
    def test_single_characters_can_be_represented_by_integers(self):
        ...
        self.assertEqual(True, ord('b') == (ord('a') + 1))  #https://www.programiz.com/python-programming/methods/built-in/ord
    ...
    def test_strings_can_be_split_with_different_patterns(self):
        ...
        # Pattern is a Python regular expression pattern which matches ',' or ';'  #https://pynative.com/python-regex-compile/
