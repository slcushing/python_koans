...
class AboutSets(Koan):
    ...
    def test_dictionaries_and_sets_use_same_curly_braces(self):
        ...
        self.assertEqual(dict, {'one': 1, 'two': 2}.__class__) #https://www.programiz.com/python-programming/set
    ...
    def test_set_have_arithmetic_operators(self):
        ...
        self.assertEqual({'Willie'}, scotsmen - warriors) #https://www.programiz.com/python-programming/operators
        self.assertEqual({'MacLeod','Wallace', 'Willie', 'Leonidas'}, scotsmen | warriors) #bitwise OR operator
        self.assertEqual({'MacLeod','Wallace'}, scotsmen & warriors) #bitwise AND operator
        self.assertEqual({'Willie', 'Leonidas'}, scotsmen ^ warriors) #bitwise XOR operator
