...
class AboutListAssignments(Koan):
    ...
    def test_parallel_assignments_with_extra_values(self):
        title, *first_names, last_name = ["Sir", "Ricky", "Bobby", "Worthington"] # * operator is unpacking operator: extends unpacking functionality to allow us to collect or unpack multiple values in a single variable https://stackabuse.com/unpacking-in-python-beyond-parallel-assignment/
