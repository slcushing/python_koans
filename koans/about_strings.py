...
class AboutStrings(Koan):
    ...
    def test_double_quoted_strings_are_strings(self):
        string = "Hello, world."
        self.assertEqual(True, isinstance(string, str)) #isinstance is looking for a Boolean
...
It was the worst of times."
        self.assertEqual(52, len(string)) #len() is looking for the length(# of items) of an object
...
world!
"""
        self.assertEqual(15, len(string)) #len() counts each character in the string INCLUDING spaces and symbols
    ...
    def test_plus_equals_will_append_to_end_of_string(self):
        ...
        there = "world"
        hi += there
        self.assertEqual("Hello, world", hi) # =+ operator adds two values together and assigns final value to a variable
    ...
    def test_most_strings_interpret_escape_characters(self):
        ...
        self.assertEqual('\n', string)
        self.assertEqual("""\n""", string)
        self.assertEqual(1, len(string)) #escape operator doesn't count towards len() number
