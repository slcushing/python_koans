...
class AboutNone(Koan):
    ...
    def test_none_is_an_object(self):
        ...
        self.assertEqual(True, isinstance(None, object)) #None is used to define a null variable or object 
    ...
    def test_none_is_distinct(self):
        ...
        self.assertEqual(True, None is not False) #https://www.educative.io/edpresso/what-is-the-none-keyword-in-python
