...
class AboutDictionaries(Koan):
    ...
    def test_dictionary_literals(self):
        empty_dict = {}
        self.assertEqual(dict, type(empty_dict))
        babel_fish = { 'one': 'uno', 'two': 'dos' } #dictionary objects have key:value pairs  https://www.programiz.com/python-programming/dictionary
    ...
    def test_changing_dictionaries(self):
        ...
        expected = { 'two': 'dos', 'one': 'eins'}  #dictionaries in python are mutable
    ...
    def test_making_a_dictionary_from_a_sequence_of_keys(self):
        ...
        self.assertEqual(42, cards['green elf']) #fromkeys - strings are all the keys and 42 is the value of each key
