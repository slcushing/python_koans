...
class AboutTuples(Koan):
    ...
    def test_tuples_are_immutable_so_appending_is_not_possible(self):
        count_of_three =  (1, 2, 5)
        with self.assertRaises(AttributeError): count_of_three.append("boom") #https://docs.python.org/3/library/exceptions.html
    ...
    def test_tuples_are_good_for_representing_records(self):
        ...
        self.assertEqual("Cthulu", locations[2][0]) # index 2 of locations
        self.assertEqual(15.56, locations[0][1][2]) #index0 of location => index1 within index0 => index2 within index1 of index0 #drilling down into items
